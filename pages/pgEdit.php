		...
		<ul data-role="listview">
			...
			<li data-role="fieldcontain">
				...
				<div class="ui-block-a">
					...
					<select name="_selBuilding" id="_selBuilding" data-job-field="Building" data-job-refresh="selectmenu">
				...
				<div class="ui-block-b">
					...
					<select name="_selFloor" id="_selFloor" data-select="range" data-select-min="1" data-select-max="3" data-job-field="Floor" data-job-refresh="selectmenu">
					</select>
				</div>
				<div class="ui-block-c">
					<label for="_selRoom">Room</label>
					<select name="_selRoom" id="_selRoom" data-select="range" data-select-min="1" data-select-max="25" data-job-field="Room" data-job-refresh="selectmenu">
					</select>
				</div>
				</fieldset>
			</li>
			...
			<li data-role="fieldcontain">
				<label for="_txtProgress">Progress</label>
				<input type="range" name="_txtProgress" id="_txtProgress" value="" min="0" max="100" data-job-scale="100" data-job-field="Progress" data-job-refresh="slider" />
			</li>
			<li class="ui-grid-a">
				<div class="ui-block-a">
